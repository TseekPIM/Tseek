        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-5 col-md-3">
                    <div class="logo">
                        <a href="index.php"><img src="assets/img/logo-2.png" alt="Zocker"></a>
                    </div>
                </div>
                        ...
                        <ul>
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="index-slick.html">Home One (Slick Hero) <span class="new-label">New</span></a></li>
                                    <li><a href="index-2.html">Home Two</a></li>
                                    <li><a href="index-2-slick.html">Home Two (Slick Hero) <span class="new-label">New</span></a></li>
                                    <li><a href="index-3.html">Home Three</a></li>
                                    <li><a href="index-3-slick.html">Home Three (Slick Hero) <span class="new-label">New</span></a></li>
                                ...
                                <ul class="mega-menu">
                                    ...
                                    <li><a href="#">Pagelist 2</a>
                                        <ul>
                                            ...
                                            <li><a href="player-details.html">Players Details</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details.html"><img src="assets/img/member/member-2-2.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details.html">Emilly</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details1.html"><img src="assets/img/member/member-2-3.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                                <div class="member-links">
                                    <a href="https://web.facebook.com/?locale=pt_BR&_rdc=1&_rdr" class="icon-btn3"><i class="fab fa-facebook-f"></i></a>
                                    <a href="https://www.twitch.tv/directory" class="icon-btn3"><i class="fab fa-twitch"></i></a>
                                    <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoicHQifQ%3D%3D%22%7D" class="icon-btn3"><i class="fab fa-twitter"></i></a>
                                </div>
                            </div>
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details1.html">Kauê</a></h3>
                            <span class="degi text-white">Phasmophobia</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details2.html"><img src="assets/img/member/member-2-1.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details2.html">danilo</a></h3>
                            <span class="degi text-white">COD</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details3.html"><img src="assets/img/member/member-2-3.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details3.html">Vitor</a></h3>
                            <span class="degi text-white">Valorant</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details4.html"><img src="assets/img/member/member-2-3.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details4.html">Davi</a></h3>
                            <span class="degi text-white">R6</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details5.html"><img src="assets/img/member/member-2-1.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details5.html">Matheus</a></h3>
                            <span class="degi text-white">CS2</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details6.html"><img src="assets/img/member/member-2-3.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details6.html">Thiago</a></h3>
                            <span class="degi text-white">Rocket League</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="vs-member image-scale-hover">
                        <div class="member-img">
                            <a href="player-details7.html"><img src="assets/img/member/member-2-1.jpg" class="w-100" alt="Member Image"></a>
                        </div>
                        <div class="member-content">
                            <div class="links-wrap text-start position-relative mb-30">
                                <span class="icon-btn3 style-white plus-icon"><i class="far fa-plus text-white"></i></span>
                            ...
                            <h3 class="member-name h5 mb-0 text-white"><a href="player-details7.html">iXavier7</a></h3>
                            <span class="degi text-white">Fifa</span>
                        </div>
                    </div>
                </div>
            </div>
